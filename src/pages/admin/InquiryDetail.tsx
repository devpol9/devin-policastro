              ...
              {Object.entries(inq.form_data || {}).map(([key, value]) => {
                ...
                return (
                  <div key={key} className="grid grid-cols-3 gap-3 text-sm">
                    <dt className="text-[11px] font-display tracking-[0.08em] text-muted-foreground uppercase-none">{key}</dt>
        ...
        <div className="space-y-5">
          ...
          <div className="glass-card p-5 space-y-2">
            ...
            <button
              ...
              className="w-full px-3 py-2 rounded-md bg-secondary text-foreground text-xs font-display font-semibold hover:bg-secondary/70 transition-colors"
            >
              Mark as contacted
            </button>
            <button
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    disabled
                    className="w-full px-3 py-2 rounded-md bg-secondary/40 text-muted-foreground text-xs font-display font-semibold opacity-60 cursor-not-allowed"
                  >
                    Convert to Project
                  </button>
                </TooltipTrigger>
            ...
            <button
              ...
              className="w-full px-3 py-2 rounded-md border border-border/40 text-foreground text-xs font-display font-semibold flex items-center justify-center gap-2 hover:bg-secondary/40 transition-colors"
            >
