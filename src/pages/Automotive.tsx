                  ...
                  <div className="relative z-10 p-5 sm:p-6">
                    ...
                    >
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-xs font-display font-semibold tracking-wider  transition-all duration-300 hover:scale-[1.02]"
                        style={{
                          background: `hsl(${COLOR})`,
                          color: `hsl(36 30% 98%)`,
                        }}
