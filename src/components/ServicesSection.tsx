...
const inquiryConfigs: Record<string, { title: string; subtitle: string; color: string; emailSubject: string; fields: any[] }> = {
  consulting: {
    ...
    fields: [
      ...
      { key: "help", label: "What do you need help with?", placeholder: "Content strategy, revenue growth, positioning...", type: "textarea", rows: 3, required: true },
  ...
  financing: {
    ...
    fields: [
      ...
      { key: "amount", label: "Amount needed (if applicable)", placeholder: "$10K, $50K, $100K+...", type: "input" },
      { key: "business", label: "Business / personal details", placeholder: "Business type, years in operation, credit score range...", type: "textarea", rows: 3, required: true },
      { key: "timeline", label: "How soon do you need this?", placeholder: "ASAP, 30 days, flexible...", type: "input" },
    ],
  },
  networking: {
    title: "Connection Request",
    subtitle: "Tell me who or what you're looking for and I'll make the introduction.",
    color: "155 75% 48%",
    emailSubject: "Networking / Introduction Request",
    fields: [
      { key: "looking-for", label: "Who are you looking for?", placeholder: "Contractor, supplier, investor, partner...", type: "textarea", rows: 3, required: true },
      { key: "industry", label: "Industry / niche", placeholder: "Fitness, real estate, automotive, tech...", type: "input", required: true },
      { key: "context", label: "Context — why do you need this intro?", placeholder: "Starting a business, need a vendor, looking for talent...", type: "textarea", rows: 3 },
