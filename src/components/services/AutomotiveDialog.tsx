                    ...
                    <div className="relative z-10 p-3 sm:p-4">
                      ...
                      <div className="flex items-center gap-1.5 mt-2">
                        ...
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-1.5 px-3 py-1.5 rounded text-[10px] sm:text-xs font-display font-semibold tracking-[0.06em]  transition-all duration-300 hover:scale-[1.02]"
                          style={{
