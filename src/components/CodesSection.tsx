    ...
    <section id="codes" className="section-padding relative overflow-hidden">
      ...
      <div className="container-tight relative z-10">
        ...
        >
          ...
          />
          <p className="text-primary/80 font-display text-[10px] tracking-[0.5em] uppercase mb-4 sm:mb-5">[ 05 — Promo Codes ]</p>
          ...
          {promoCodes.map((promo, i) => (
            ...
            >
              <TiltCard intensity={6}>
                <div className="glass-card p-4 sm:p-6 relative overflow-hidden hover:border-primary/20 transition-all duration-700 group">
                  {ripple === promo.code && (
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between mb-4 sm:mb-5">
                      <div>
                        <h3 className="font-display font-bold text-sm sm:text-base group-hover:text-primary transition-colors duration-300">{promo.brand}</h3>
                        <div className="flex items-center gap-1.5 mt-1">
                          <Sparkles size={11} className="text-primary/70" />
                          <p className="text-primary/80 text-xs sm:text-sm font-medium">{promo.discount}</p>
                        </div>
                      </div>
                      <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-primary/8 flex items-center justify-center group-hover:bg-primary/15 group-hover:scale-105 transition-all duration-500 shrink-0">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-2 px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg bg-card border border-border/30 font-mono text-[10px] sm:text-xs font-bold tracking-[0.15em] hover:border-primary/30 transition-all group/copy relative overflow-hidden"
                      >
                      ...
                      <a
                        ...
                        className="px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg bg-primary text-primary-foreground font-display font-semibold text-[10px] sm:text-xs tracking-wide hover:shadow-lg hover:shadow-primary/20 hover:scale-[1.02] transition-all duration-500 flex items-center gap-1.5 shrink-0"
                      >
