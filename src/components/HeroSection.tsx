  ...
  return (
    <section id="home" ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div style={{ opacity, scale, y }} className="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto pt-20 sm:pt-16 w-full">
        ...
        <h1 className="font-display font-extrabold text-[2rem] xs:text-[2.6rem] sm:text-7xl md:text-8xl lg:text-[10rem] leading-[0.85] mb-4 tracking-[-0.03em] w-full overflow-hidden">
          <motion.span
